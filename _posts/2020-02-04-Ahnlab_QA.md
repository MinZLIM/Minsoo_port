...
<br />
Detail info : [Maintain Test Server info](https://minzlim.github.io/Minsoo_port/2020/02/02/Maintain_Server)
...
#### 자동화 Test 수행
fqdn 객체의 ip 동시 수집 시 iphash 정보가 저장되지 않는 사이트 이슈 재현 Aging Bash Script <br />
Detail info : 
...
보안 장비로써 근간이 되는 기능으로 다음과 같은 보안 정책들을 지원한다. 
 ...
 - IPv4/IPv6 (이 내용은 bash 스크립트 상세 내용으로 변경 하자) 
...
> 프로토콜 이상 기능 검증을 위한 프로토콜 헤더 내용 변조 bash shell 스크립트 기반 tool 생성

Detail info : bash

Python3 기반 방화벽 정책의 최대값 ,랜덤값 입력 자동화 수행
Detail info : tpat
